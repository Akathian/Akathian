...
|                                  Artificial Intelligence | ML/DL Frameworks (PyTorch, Tensorflow, Keras, NumPy, Scikit-learn, Gensim), MLOps (AWS Sagemaker), NLP (LSA, TF-IDF, MDS, T-SNE, Neural Networks, LDA), CV (RBF, CNN), Classification (Naive Bayes, KNN, Random Forest), Clustering (K-Means, GMM, Naive Bayes),  Regression                                                                         |
